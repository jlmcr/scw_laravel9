$(document).ready(function() {
    $('#date-mask-input-a').mask("00/00/0000", { placeholder: "__/__/____" });
    $('#date-mask-input-b').mask("00/00/0000", { placeholder: "__/__/____" });
    $('#date-mask-input-c').mask("00/00/0000", { placeholder: "__/__/____" });
