...
@section('css')
    <style>
            /* este no tiene encabezado */
        html {
            margin: 27pt 38pt 32pt 40pt; //margenes de la hpja pdf a d ab iz //32pt 32pt 32pt 32pt
                ...
                <table class="tabla-encabezado azul">
                    ...
                    <tr>
                        <td colspan="5" style="text-align: center; font-size: 16px;">
                            COMPROBANTE DE {{$comprobante->tipo->nombre}}
                        </td>
                    </tr>
                    <tr>
            ...
            <div>
                <table class="datosComprobante" style="font-size: 15px; width: 100%;">
                    <tr>
                        ...
                        <td class="izquierda">
                            @php
                                $fecha = date('d/m/Y', strtotime($comprobante->fecha));
                            @endphp
                            <p>{{$fecha}}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <p>{{$comprobante->numeroDocumento}}</p>
                        </td>
                    </tr>
                </table>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ( $detalleComprobante as $detalle )
                                @if ($detalle->comprobante_id == $comprobante->id)
                                    ...
                                    {{--! cuenta de la subcuenta utilizada --}}
                                ...
                                <th colspan="3" style="text-align: left">
                                    <?php
                                        try {
                                            ...
                                            if( $key ==$comprobante->id)
                                            {
                                                echo "<p>".$value['literal']."</p>";
                                            }
                                        }
                                        } catch (\Throwable $th) {
